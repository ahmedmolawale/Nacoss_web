...
if(checkmatricdinner($umatric)=='N'){
		...
		elseif(!filter_var($uemail,FILTER_VALIDATE_EMAIL)){
			...
			insertdinner($umatric,$uname,$uphoneno,$ulevel,$uemail);
...
<head>
    ...
    <title>Resources > Dinner Committee REGISTER | Nacoss Unibadan</title>
    ...
    <section id="title" class="opahead">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1>Register </h1>
                    <p>NACOSS 2014/2015 DINNER COMMITTE .</p>
                </div>
                <div class="col-sm-6">
       ...
       <form method="POST" class="center" role="form" >
            <fieldset class="registration-form" size="75%" >
                <div class="form-group">
                    <input type="text"  name="matric" placeholder="matric number" required class="form-control" size="50%" >
                </div>
				 <div class="form-group">
