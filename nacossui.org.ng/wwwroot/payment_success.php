...
<head>
    ...
    <title>Payment Status | Nacoss Unibadan</title>
...
<body>
    ...
    <section id="title" class="opahead">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <h2>Congratulations <?php $found_nacossite->full_name()." ."?> </h2>
                <h2>You have successfully completed your payment. Please print/screenshot a copy of your receipt and proceed to the NACOSS secretariat with it.  </h2>
            </div>
            <div class="col-md-12">
                <h2>You can always contact us <i class='icon-hand-right'></i> <a href="contact.php">here</a> if you have any issue .</h2>

            </div>
           <a href="receipt.php"><input type="submit" name="send" class="btn btn-primary btn-lg" value="Generate Receipt"></a>
